...
object Config {
    ...
    private val GLOBAL_SETTINGS = listOf("first_launch", "analytics", "discreet_icon", "material_you", "debug_mode", "enable_watchdog_service", "disable_permission_checks", "custom_manifest")
