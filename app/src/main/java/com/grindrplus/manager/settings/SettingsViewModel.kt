...
class SettingsViewModel(
        ...
        viewModelScope.launch {
            ...
            try {
                _settingGroups.value = listOf(
                    SettingGroup(id = "hooks", title = "Manage Hooks", settings = buildHookSettings()),
                    SettingGroup(id = "tasks", title = "Manage Tasks", settings = buildTaskSettings()),
                    SettingGroup(id = "other", title = "Other Settings", settings = buildOtherSettings()),
                    SettingGroup(id = "manager", title = "Manager Settings", settings = buildManagerSettings()),
                )
            } finally {
    ...
    private fun buildHookSettings(): List<SwitchSetting> {
    ...
    private fun buildTaskSettings(): List<SwitchSetting> {
        val tasks = Config.getTasksSettings()
        return tasks.map { (taskId, pair) ->
            SwitchSetting(
                id = taskId,
                title = taskId,
                description = pair.first,
    ...
    private fun buildOtherSettings(): List<Setting> {
    ...
    private fun buildManagerSettings(): List<Setting> {
